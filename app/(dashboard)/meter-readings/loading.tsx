// app/(dashboard)/meter-readings/loading.tsx
    ...
    <div className="space-y-6 animate-pulse">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-2">
          <div className="h-8 w-60 bg-slate-200 rounded-[8px]" />
          <div className="h-4 w-80 bg-slate-100 rounded-[6px]" />
        </div>
        <div className="h-10 w-44 bg-slate-200 rounded-[10px]" />
      </div>

      <div className="h-10 bg-slate-100 rounded-[10px] p-2" />
      ...
      <div className="bg-white border border-slate-200 rounded-[12px] p-4 space-y-3">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="h-12 bg-slate-50 rounded-[8px] flex items-center px-4 justify-between">
            ...
            <div className="h-8 w-28 bg-slate-200 rounded-[6px]" />
            <div className="h-4 w-20 bg-slate-100 rounded-[4px]" />
            <div className="h-8 w-28 bg-slate-200 rounded-[6px]" />
