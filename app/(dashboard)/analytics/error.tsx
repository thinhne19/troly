...
// app/(dashboard)/analytics/error.tsx — Analytics Error Boundary
  ...
  return (
    <div className="min-h-[500px] flex flex-col items-center justify-center p-8 bg-white border border-rose-200 rounded-[16px] text-center shadow-xs">
      ...
      <h2 className="text-xl font-bold text-slate-900 mb-1">
        Lỗi khi tải báo cáo phân tích tài chính
      </h2>
      <p className="text-sm text-slate-500 max-w-md mb-6 leading-relaxed">
        {error.message || 'Đã xảy ra sự cố trong quá trình tổng hợp số liệu doanh thu và ma trận nợ. Vui lòng thử lại.'}
      </p>
