...
function middleware(request) {
    ...
    if (pathname.startsWith('/_next') || pathname.startsWith('/api') || pathname.startsWith('/icons') || pathname.includes('.') || pathname === '/manifest.webmanifest') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
    }
    // Public auth pages
    const isAuthPage = pathname === '/login';
    // Check auth session from cookie
    const sessionToken = request.cookies.get('troly_session_token')?.value || request.cookies.get('sb-access-token')?.value;
